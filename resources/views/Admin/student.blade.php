...
<body class="crm_body_bg">
        ...
        <div class="main_content_iner ">
            <div class="container-fluid p-0">
                <div class="row justify-content-center">
                                        ...
                                        <div class="quick_activity_wrap">
                                            <div class="single_quick_activity d-flex" onclick="alumini_list()">
                                                ...
                                                <div class="count_content">
                                                    <h3><span>{{ $studentCount }}</span> </h3>
                                                    <p>Registered Students</p>
                                                </div>
                                            </div>

                                            <div class="single_quick_activity d-flex" onclick="UnRegStudent_list()">
                                                <div class="icon">
                                                    <img src="../img/icon/student.svg" alt="image">
                                                </div>
                                                <div class="count_content">
                                                    <h3><span>{{ $UnRegStudentCount }}</span> </h3>
                                                    <p>Unregistered Students</p>
                                                </div>
                                            </div>

                                            <div class="image-upload" style="padding-top: 10px;" onclick="AddStudent()">
                        ...
                        <div class="QA_section">
                            <div class="QA_table mb_30">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @if (count($studentList) != null)
                                            @foreach ($studentList as $list)
                                                <tr>
                                                    <td>
                                                        @if ($list->profilePicture != null)
                                                            <img
                                                                src="{{ asset('../img/student/' . $list->profilePicture) }}">
                                                        @else
                                                            <img src="../img/profile.png" alt="#">
                                                        @endif
                                                    </td>
                    ...
                    <div class="col-12" id="unRegStudent_table">
                        <div class="QA_section">
                            <div class="QA_table mb_30">
                                <table class="table">
                                    <thead>
                                    ...
                                    <tbody>
                                        @if (count($unRegStudentsList) != null)
                                            @foreach ($unRegStudentsList as $list)
                                                <tr>
                                                    <td>
                                                        @if ($list->profilePicture != null)
                                                            <img
                                                                src="{{ asset('../img/student/' . $profile->profilePicture) }}">
                                                        @else
                                                            <img src="../img/profile.png" alt="#">
                                                        @endif
                                                    </td>
                    ...
                    <div class="col-lg-6" id="addStudent">
                        <div class="white_box mb_30">
                            ...
                            <form action="{{ url('importfile') }}" method="POST" enctype="multipart/form-data" name="quickForm">
                                {{ csrf_field() }}
    ...
    <script>
        ...
        function UnRegStudent_list() {
            var x = document.getElementById("unRegStudent_table");
            if (x.style.display === "block") {
                x.style.display = "none";
            } else {
                x.style.display = "block";
        ...
        function AddStudent() {
            var x = document.getElementById("addStudent");
            if (x.style.display === "block") {
                x.style.display = "none";
            } else {
                x.style.display = "block";
