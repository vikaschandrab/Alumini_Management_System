<form class="login100-form validate-form" method="GET" name="submitOTP" id="submitOTP" action="/forgotPassword" enctype ="multipart/form-data">
    ...
    <div id="myDIV4">
        <div class="wrap-input100 validate-input" data-validate = "Enter username">
            ...
            {{-- <input class="input100" type="text" name="mobilenumber" id="mobilenumber" autocomplete="off" oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"> --}}
            <p class="input100" type="text" name="emailId" id="emailId" autocomplete="off" oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"></p>
        </div>
